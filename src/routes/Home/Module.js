...
const employeesSlice = createSlice({
  ...
  reducers: {
    changeInformationMethodStatus(state, action) {
      ...
      selectedItemIndex = state.items.findIndex(item => item.id === action.payload.id);
      ...
      updatedItem = {
        ...
        informationMethod: {
          ...
          [action.payload.method]: !selectedItem.informationMethod[action.payload.method],
        },
      };
    ...
    putEmployee(state, action) {
      const selectedItemIndex = state.items.findIndex(item => item.id === action.payload.id);
...
export const { changeInformationMethodStatus, deleteEmployee, addEmployee, putEmployee } =
